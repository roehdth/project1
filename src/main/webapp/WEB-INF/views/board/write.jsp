...
<center>
	...
	<form>
		...
		<br/><br/>
		<input style="cursor: pointer" type="button" class="write" value="작성하기" onClick="createB()" />
	</form>
	
		<button style="cursor: pointer; float:right;" class="listp"onClick="location.href='board'">목록</button>
	</div>
</center>
