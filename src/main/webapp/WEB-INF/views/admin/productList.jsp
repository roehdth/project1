...
<body>
	...
	<div>
		...
		<form name="f3rm" id="f3rm" method="post" action="updateProduct"
				...
				<c:forEach begin="0" end="${(fn:length(map.list))}" var="i">
					...
					<c:if test="${not empty product}">
						<tr>
							...
							<td><a class="id"
								onclick="location.href='prdupdate?prd_id=${product.prd_id}'">${product.prd_id}</a>
				...
				<tr>
					<td colspan="6">
						...
						<div id="search2" align="center">
							<input type="text" name="sPrd2" id="sPrd2" placeholder="검색어 입력"
								onkeypress="if(event.keyCode == 13) {searchPrd2(); return;}">
							<button type="button" id="searchBtn" onclick="searchPrd2()"
