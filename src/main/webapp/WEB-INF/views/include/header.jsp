...
<div>
	<div>
		<img src="resources/image/header/bannerImage.png" alt="이벤트 배너"
			style="width: 100%; height: 100px;">
	</div>
	<div id="icon" align="right">
		<form name="frm" id="inner">
			<h1 id="main_title">
				<a href="main"><img src="resources/image/header/logo.png"
			...
			<c:choose>
				<c:when test="${member.member_id eq 'Admin'}">
					<img class="prdinsert"
						src="resources/image/header/productinsert.svg"
						onclick="location.href='prdinsert'" style="cursor: pointer"
						title="상품등록">
					<img class="prdlist" src="resources/image/header/productlist.svg"
						onclick="location.href='productList'" style="cursor: pointer"
						title="상품관리">
					<i class="fa fa-user-times  fa-2x" onclick="location.href='logout'"
						style="cursor: pointer" title="로그아웃"></i>
					<i class="fa fa-user  fa-2x" onclick="location.href='memberList'"
						style="cursor: pointer" title="회원관리"></i>
					<img class="prdorder" src="resources/image/header/order.png"
						onclick="location.href='paymentList'" style="cursor: pointer"
						title="주문관리">
				</c:when>
				<c:when test="${member.member_id == null}">
					<i class="fa fa-user-plus fa-2x" onclick="location.href='signup'"
						style="cursor: pointer" title="회원가입"></i>
					<i class="fa fa-user  fa-2x" onclick="location.href='login'"
						style="cursor: pointer" title="로그인"></i>
				</c:when>
				...
				<c:otherwise>
					...
					<i class="fa fa-shopping-cart fa-2x" onclick="productCart()"
						style="cursor: pointer" title="장바구니"></i>
					<i class="fa fa-shopping-bag fa-2x" onClick="mypBtn()"
						style="cursor: pointer" title="마이페이지"></i>
				</c:otherwise>
			</c:choose>
