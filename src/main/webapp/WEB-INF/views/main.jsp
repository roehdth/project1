					...
					<div class="hover_effect_box hover_effect_1">
						...
						<div class="caption">
							...
							<div class="caption_desc">
								남녀노소 입을 수 있는 청바지<br> 가성비 좋은 청바지
							</div>
							<a herf="" onclick="location.href='productpage?prd_id=LOW005'" class="caption_link">더 보기</a>
						</div>
					</div>
				</td>
				<td>
				...
				<td>
					<div class="hover_effect_box hover_effect_1">
						...
						<div class="caption">
							...
							<div class="caption_desc">
								남녀노소 입을 수 있는 맨투맨<br> 가성비 좋은 맨투맨
							</div>
							<a herf="#"
								onclick="location.href='category?cate_id=TOP20220010'"
								class="caption_link">더 보기</a>
						</div>
					</div>
				</td>
				<td>
					<div class="hover_effect_box hover_effect_1">
						...
						<div class="caption">
							...
							<div class="caption_desc">
								남녀노소 입을 수 있는 츄리닝 바지<br> 가성비 좋은 츄리닝바지
							</div>
							<a herf="#" class="caption_link">더 보기</a>
						</div>
					</div>
				...
				<td>
					<div class="hover_effect_box hover_effect_1">
						...
						<div class="caption">
							...
							<div class="caption_desc">
								남녀노소 입을 수 있는 긴팔티<br> 가성비 좋은 긴팔티
							</div>
							<a herf="#"
								onclick="location.href='category?cate_id=TOP20220010'"
								class="caption_link">더 보기</a>
				...
				<td>
					<div class="hover_effect_box hover_effect_1">
						...
						<div class="caption">
							...
							<div class="caption_desc">
								남녀노소 입을 수 있는 조거 츄리닝 바지<br> 가성비 좋은 조거 츄리닝 바지
							</div>
							<a herf="#" class="caption_link">더 보기</a>
						</div>
					</div>
				...
				<td>
					<div class="hover_effect_box hover_effect_1">
						...
						<div class="caption">
							...
							<div class="caption_desc">
								남녀노소 입을 수 있는 카라 맨투맨<br> 가성비 좋은 카라 맨투맨
							</div>
							<a herf="#"
								onclick="location.href='category?cate_id=TOP20220010'"
								class="caption_link">더 보기</a>
				...
				<td>
					<div class="hover_effect_box hover_effect_1">
						...
						<div class="caption">
							...
							<div class="caption_desc">
								남녀노소 입을 수 있는 후드티<br> 가성비 좋은 후드티
							</div>
							<a herf="#" onclick="location.href='productpage?prd_id=TOP003'"
								class="caption_link">더 보기</a>
						</div>
					</div>
				</td>
				...
				<td>
					<div class="hover_effect_box hover_effect_1">
						...
						<div class="caption">
							...
							<div class="caption_desc">
								남녀노소 입을 수 있는 후드 야상<br> 가성비 좋은 후드 야상
							</div>
							<a herf="#" class="caption_link">더 보기</a>
						</div>
					</div>
				...
				<td>
					<div class="hover_effect_box hover_effect_1">
						...
						<div class="caption">
							...
							<div class="caption_desc">
								남녀노소 입을 수 있는 세트 옷<br> 가성비 좋은 세트 옷
							</div>
							<a herf="#" class="caption_link">더 보기</a>
						</div>
					</div>
